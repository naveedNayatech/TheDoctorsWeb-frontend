...
function App() {
  return (
    <Router>
        ...
        <StaffProtectedRoute exact path="/doctor/report/timesummaryreport" component={DoctorTimeSummaryReport} />
        {/* HR Routes */}
        ...
        <HRProtectedRoute exact path="/hr/report/timesummaryreport" isHR={true} component={HRSummaryReport} />
    </Router>
  )      
};
